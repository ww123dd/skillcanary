...
- [~] externally sourced regressions: 20 in place (nine public sources, each with a before/after pair); target 50-100
...
- [~] externally sourced regressions: 10 in place (five upstream changes, each with a public source and a before/after pair); target 50-100
