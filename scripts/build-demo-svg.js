...
if (bad.code === 0 || good.code !== 0) { console.error('refusing to render: the demo does not flip'); process.exit(1); }
const rows = [];
let y = 96;
...
y += 18;
row('same case - the only difference is whether the change can prove what it fixed', '#8b949e', 15);
